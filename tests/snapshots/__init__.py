...
members = snapshot(
    {
        ...
        (
            ...
            ("inherited_members", ("method1",)),
            ("members", True),
        ): external("b1578c6a8690*.html"),
        (
            ("filters", "public"),
            ("inherited_members", True),
            ("members", True),
        ): external("4c85bfd01588*.html"),
        (
            ("filters", "public"),
            ("inherited_members", False),
            ("members", True),
        ): external("7249589a02af*.html"),
        (
            ("filters", "public"),
            ("inherited_members", ()),
            ("members", False),
        ): external("0ee604c0e687*.html"),
        (
            ("filters", "public"),
            ("inherited_members", ("method1",)),
            ("members", False),
        ): external("9e82b7281578*.html"),
        (
            ("filters", "public"),
            ("inherited_members", True),
            ("members", False),
        ): external("f6c60f9022a3*.html"),
        (
            ("filters", "public"),
            ("inherited_members", False),
            ("members", False),
        ): external("2c72eeb7a881*.html"),
        ...
        (
            ...
            ("inherited_members", ("method1",)),
            ("members", None),
        ): external("15cfd999edd0*.html"),
        (
            ("filters", "public"),
            ("inherited_members", True),
            ("members", None),
        ): external("909a125c463b*.html"),
        (
            ("filters", "public"),
            ("inherited_members", False),
            ("members", None),
        ): external("7eb9800b7d99*.html"),

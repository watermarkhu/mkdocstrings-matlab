...
if TYPE_CHECKING:
    ...
    from mkdocstrings_handlers.matlab.handler import MatlabHandler
...
def fixture_session_handler(session_plugin: MkdocstringsPlugin, session_ext_markdown: Markdown) -> MatlabHandler:
    """Return a handler instance.
